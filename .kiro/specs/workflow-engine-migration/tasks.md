...
- [x] 1. Update packages and add domain types
  - [x] 1.1 Update NuGet package references
  ...
  - [x] 1.5 Create LlmCallRecord persistence entity
...
- [x] 2. Implement LLM telemetry middleware and store
  - [x] 2.1 Create LlmTelemetryStore
  ...
  - [x] 2.2 Create LlmTelemetryMiddleware (DelegatingChatClient)
...
- [x] 3. Implement ChatClientAgentFactory with structured output
  - [x] 3.1 Create ChatClientAgentFactory
...
- [x] 4. Implement workflow executors
  - [x] 4.1 Create ClassificationExecutor
  ...
  - [x] 4.2 Create TeamAssignmentExecutor
  ...
  - [x] 4.3 Create AgentAssignmentExecutor
  ...
  - [x] 4.4 Create ResolutionExecutor
  ...
  - [x] 4.5 Create CodeGenerationExecutor
  ...
  - [x] 4.6 Write unit tests for all executors
...
- [x] 6. Implement Human Approval Gate and workflow persistence
  - [x] 6.1 Create HumanApprovalGate via RequestPort
  ...
  - [x] 6.2 Create WorkflowCheckpointStore
  ...
  - [x] 6.3 Create WorkflowApprovalService
...
- [x] 7. Build SupportWorkflowFactory and wire the workflow graph
  - [x] 7.1 Create SupportWorkflowFactory
  ...
  - [x] 7.2 Create new IOrchestrator implementation using workflow engine
...
- [x] 9. Create DI registration and update Program.cs
  - [x] 9.1 Create AddWorkflowEngine extension method
  ...
  - [x] 9.2 Update Program.cs to use AddWorkflowEngine
  ...
  - [x] 9.3 Update InboxProcessor to use new workflow engine
...
- [x] 10. Create new API endpoints
  - [x] 10.1 Create ApprovalEndpoints
  ...
  - [x] 10.2 Create TelemetryEndpoints
...
- [x] 11. Implement workflow event streaming
  - [x] 11.1 Create WorkflowEventBridge
  ...
  - [x] 11.2 Write property test for Workflow Event Completeness
    - **Property 7: Workflow Event Completeness**
    - **Validates: Requirements 5.1, 5.4**

- [x] 12. Delete Akka.NET actors and related code
  - [x] 12.1 Delete Akka actor files and interfaces
  ...
  - [x] 12.2 Remove old service implementations replaced by executors
  ...
  - [x] 12.3 Remove old Orchestrator
...
- [x] 13. Checkpoint - Ensure backend compiles and all tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 14. Frontend — Update types and pipeline visualizer
  - [x] 14.1 Update WorkflowStage TypeScript type
  ...
  - [x] 14.2 Update pipeline visualizer for AwaitingApproval
  ...
  - [x] 14.3 Update OverviewPage stats to include awaiting approval count
    - Add a stats card showing count of workflows in AwaitingApproval stage
    - _Requirements: 12.5_

- [x] 15. Frontend — Create Approvals page
  - [x] 15.1 Add API client functions for approvals
  ...
  - [x] 15.2 Create ApprovalsPage component
  ...
  - [x] 15.3 Add ApprovalsPage to router and navigation
    - Add route for `/approvals` in the app router
    - Add navigation link in the sidebar/header
    - _Requirements: 11.1_

- [x] 16. Frontend — Add telemetry display to Agents page
  - [x] 16.1 Add API client functions for telemetry
  ...
  - [x] 16.2 Update AgentsPage with telemetry display
  ...
  - [x] 16.3 Write frontend property test for cost estimate calculation
